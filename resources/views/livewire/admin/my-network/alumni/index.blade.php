                        ...
                        <tr>
                            ...
                            <th>
                                <a wire:click.prevent="sortBy('city')" role="button" href="#">
                                    {{trans("general.town")}}
                                    @include('layouts.partials._sort-icon', ['field' => 'city'])
                                </a>
                            </th>
                            <th>
                                <a wire:click.prevent="sortBy('alumni_year')" role="button" href="#">
                                    {{trans("general.year")}}
                                    @include('layouts.partials._sort-icon', ['field' => 'alumni_year'])
                                </a>
                            </th>
                            <th>
                    ...
                    @forelse($alumni as $item)
                        <tbody>
                            <tr>
                                ...
                                <td>{{$item->city}}</td>
                                <td>{{$item->alumni_year}}</td>
                                <td>
                                    <a href="{{route("admin.my-network.alumni.edit",$item->id)}}">
