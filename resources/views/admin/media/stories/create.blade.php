...
@section('content')
    ...
    <div class="content medias" id="responsive_headline">
        ...
        <form action="{{route("admin.media.stories.store")}}" class="js-validation-bootstrap"
              enctype="multipart/form-data" method="POST">
            @csrf
            <div class="block">
                <div class="block-header bg-primary rounded-top">
                    <h3 class="text-white font-weight-light font-size-h3 mb-0">{{trans("general.new-story")}}</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xl-5">
                                    <div class="form-group">
                                        <label>{{trans("general.alumni")}}</label>
                                        <select name="alumnus_id" class="form-control select2" required>
